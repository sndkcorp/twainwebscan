...
function _show_install_dialog(ProductName, objInstallerUrl, bHTML5, iPlatform, bIE, bSafari, bSSL, strIEVersion) {
	...
	ObjString = [
		'<div class="dynamsoft-dwt-dlg-title" style="text-align: center;">',
		title,
		'</div>'];
	...
	if (bHTML5) {
		...
		ObjString.push('<div><span class="dynamsoft-dwt-installdlg-text" style="margin: 0px 100px 0px 0px">Download</span>');
		ObjString.push('<span class="dynamsoft-dwt-installdlg-text" style="margin: 0px 125px 0px 0px">Install</span>');
		ObjString.push('<span class="dynamsoft-dwt-installdlg-text" style="">Scan</span>');
		ObjString.push('</div>');
		ObjString.push('</div>');
	}
	...
	ObjString.push('" onclick="DCP_DWT_onclickInstallButton(this)"><div class="dynamsoft-dwt-dlg-button" style="text-align: center;">Click here to Download Setup</div></a>');
	if (bHTML5) {
		if (bIE) {
			...
			ObjString.push('<div class="dynamsoft-dwt-dlg-red">If you want to purchase own <a href="https://www.dynamsoft.com">Dynamsoft</a> license <a href="https://www.dynamsoft.com">click here</a>.</div>');
			ObjString.push('</div>');
		}
